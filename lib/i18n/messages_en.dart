...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "w102" : MessageLookupByLibrary.simpleMessage("Note: If you already have backup file you need to override it. Otherwise, the system will create it as a new file that will consume your storage space unnecessarily. To override, simply tap on it and then press save button"),
    ...
    "w75" : MessageLookupByLibrary.simpleMessage("NoteFlow made by independent developer and it needs to be translated to other languages. So, If you want to contribute to the translation please email me from feedback section. It really helps to other people and also me :)"),
